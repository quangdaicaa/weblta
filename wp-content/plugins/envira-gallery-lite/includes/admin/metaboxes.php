...
class Envira_Gallery_Metaboxes {
	...
	public function do_default_display( $post ) {
		...
		<p class="envira-intro">
			...
			<small>
				...
				<a href="<?php echo esc_url( $upgrade_link ); ?>" class="envira-doc" target="_blank">
        ...
        </div><p class="no-margin-top"><strong>Bonus:</strong> Envira Lite users get a discount code for 10% off regular price.</p>',
			'warning',
	...
	public function config_tab( $post ) {
			...
			<table class="form-table" style="margin-bottom: 0;">
				<tbody>
					...
					<tr id="envira-config-lazy-loading-box">
						...
						<td>
							<input id="envira-config-lazy-loading" type="checkbox" name="_envira_gallery[lazy_loading]" value="<?php echo esc_attr( $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ) ); ?>" <?php checked( $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ), 1 ); ?> />
					...
					<tr id="envira-config-lazy-loading-box">
						...
						<td>
							<input id="envira-config-lazy-loading" type="checkbox" name="_envira_gallery[lazy_loading]" value="<?php echo esc_attr( $this->get_config( 'lazy_loading', $this->get_config_default( 'lazy_loading' ) ) ); ?>" <?php checked( $this->get_config( 'lazy_loading' ), 1 ); ?> />
							<span class="description"><?php esc_html_e( 'Enables or disables lazy loading, which helps with performance by loading thumbnails only when they are visible. See our documentation for more information.', 'envira-gallery-lite' ); ?></span>
						</td>
					</tr>
				...
				<table class="form-table">
					<tbody>
						...
						<tr id="envira-config-crop-box">
							...
							<td>
								<input id="envira-config-crop" type="checkbox" name="_envira_gallery[crop]" value="<?php echo esc_attr( $this->get_config( 'crop', $this->get_config_default( 'crop' ) ) ); ?>" <?php checked( $this->get_config( 'crop', $this->get_config_default( 'crop' ) ), 1 ); ?> />
		...
		Envira_Gallery_Notice_Admin::get_instance()->display_inline_notice(
            ...
            <ul>
                <li><a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/customize-your-envira-galleries-with-new-gallery-layouts', 'adminpageconfig', 'customgallerythemes' ) ) . '">Custom Gallery Themes</a></li>
                <li><a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/how-to-optimize-image-galleries-for-mobile-using-envira-gallery/', 'adminpageconfig', 'mobileoptimizedgalleries' ) ) . '">Mobile Optimized Galleries</a></li>
                <li><a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/how-to-upload-photos-directly-from-lightroom-to-wordpress/', 'adminpageconfig', 'adobelightroomintegration' ) ) . '">Adobe Lightroom Integration</a></li>
            </ul>
            <ul>
                <li><a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/how-to-sell-your-photos-in-wordpress/', 'adminpageconfig', 'woocommerceintegration' ) ) . '">Woocommerce Integration</a></li>
                <li><a target="_blank" href="' . esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/how-to-protect-your-website-from-image-theft/', 'adminpageconfig', 'imageprotection' ) ) . '">Image Protection</a></li>
			...
			<table class="form-table no-margin">
				<tbody>
					<tr id="envira-config-lightbox-enabled-box">
						...
						<td>
							<input id="envira-config-lightbox-enabled" type="checkbox" name="_envira_gallery[lightbox_enabled]" value="<?php echo esc_attr( $this->get_config( 'lightbox_enabled', $this->get_config_default( 'lightbox_enabled' ) ) ); ?>" <?php checked( $this->get_config( 'lightbox_enabled', $this->get_config_default( 'lightbox_enabled' ) ), 1 ); ?> />
				...
				<tbody>
					...
					<tr id="envira-config-classes-box">
						...
						<td>
							...
							$classes        = $this->get_config( 'classes', $gallery_data );
					...
					<tr id="envira-config-rtl-box">
						...
						<td>
							<input id="envira-config-rtl" type="checkbox" name="_envira_gallery[rtl]" value="<?php echo esc_attr( $this->get_config( 'rtl', $this->get_config_default( 'rtl' ) ) ); ?>" <?php checked( $this->get_config( 'rtl', $this->get_config_default( 'rtl' ) ), 1 ); ?> />
	...
	public function lite_mobile_tab( $post ) {
		...
		<div class="upgrade-header">
			<img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/responsive-icon.png' ); ?>" width="35" height="35" />
		...
		<div class="upgrade-content">
			<div class="hero-image-exterior">
				<div class="interior">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/features/responsive-mobile-friendly/', 'adminpagemobile', 'mobilefeaturesimage' ) ); ?>" target="_blank"><img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/mobile.jpg' ); ?>" /></a>
				</div>
			</div>
			...
			<div class="cta-buttons">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/features/responsive-mobile-friendly/', 'adminpagemobile', 'viewmobiledemo' ) ); ?>" target="_blank" class="button button-secondary">View Mobile Demo</a>
	...
	public function lite_videos_tab( $post ) {
		...
		<div class="upgrade-header">
			<img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/videos-icon.png' ); ?>" width="35" height="35" />
		...
		<div class="upgrade-content">
			<div class="hero-image-exterior">
				<div class="interior">
					<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videosaddonimage' ) ); ?>" target="_blank"><img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/videos-addon.png' ); ?>" /></a>
				</div>
			</div>
			...
			<div class="two-column-list">
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">Self-hosted Videos</a> (MP4)</li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">YouTube</a> (with playlist and custom start time support)</li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">Vimeo</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">Instagram</a> Feed Videos</li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagesocial', 'videoplatformlinks' ) ); ?>">Instagram</a> IGTV</li>
				</ul>
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">Twitch</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">VideoPress</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'videoplatformlinks' ) ); ?>">DailyMotion</a></li>
					<li><strong>...and more!</strong></li>
				</ul>
			</div>
			<p><strong>Bonus:</strong> Envira Lite users get a discount code for 10% off regular price.</p>
			<div class="cta-buttons">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/video-gallery-demo/', 'adminpagevideos', 'viewvideoaddondemobutton' ) ); ?>" target="_blank" class="button button-secondary">View Video Addon Demo</a>
	...
	public function lite_social_tab( $post ) {
		...
		<div class="upgrade-header">
			<img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/social-icon.png' ); ?>" width="35" height="35" />
		...
		<div class="upgrade-content">
			<div class="hero-image-exterior">
				<div class="interior">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharingaddonimage' ) ); ?>" target="_blank"><img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/socialsharing.png' ); ?>" /></a>
				</div>
			</div>
			...
			<div class="two-column-list">
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">Facebook</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">Twitter</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">PInterest</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">LinkedIn</a></li>
				</ul>
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">WhatsApp</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'socialsharinglinks' ) ); ?>">Email</a></li>
					<li><strong>...and more!</strong></li>
				</ul>
			</div>
			<p><strong>Bonus:</strong> Envira Lite users get a discount code for 10% off regular price.</p>
			<div class="cta-buttons">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/social-sharing-demo/', 'adminpagesocial', 'viewsocialaddondemobutton' ) ); ?>" target="_blank" class="button button-secondary">View Social Addon Demo</a>
	...
	public function lite_tags_tab( $post ) {
		...
		<div class="upgrade-header">
			<img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/tags-icon.png' ); ?>" width="35" height="35" />
		...
		<div class="upgrade-content">
			<div class="hero-image-exterior">
				<div class="interior">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/gallery-tags/', 'adminpagetags', 'tagsaddonimage' ) ); ?>" target="_blank"><img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/tags-addon.png' ); ?>" /></a>
				</div>
			</div>
			...
			<div class="cta-buttons">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/gallery-tags/', 'adminpagetags', 'viewtagsaddondemobutton' ) ); ?>" target="_blank" class="button button-secondary">View Tags Addon Demo</a>
	...
	public function lite_pagination_tab( $post ) {
		...
		<div class="upgrade-header">
			<img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/pagination-icon.png' ); ?>" width="35"  />
		...
		<div class="upgrade-content">
			<div class="hero-image-exterior">
				<div class="interior">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/gallery-pagination-demo/', 'adminpagepagination', 'paginationaddonimage' ) ); ?>" target="_blank"><img src="<?php echo esc_url( trailingslashit( ENVIRA_URL ) . 'assets/images/pagination-addon.png' ); ?>" /></a>
				</div>
			</div>
			...
			<div class="two-column-list">
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/pagination-demo/', 'adminpagepagination', 'bypageajaxorstandard', '#envira-pagination-click-ajax' ) ); ?>">By Page (Ajax Or Standard)</a></li>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/pagination-demo/', 'adminpagepagination', 'onscroll', '#envira-pagination-scroll' ) ); ?>">On Scroll</a></li>
				</ul>
				<ul>
					<li><a target="_blank" href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/addons/pagination-addon', 'adminpagepagination', 'clickmorebutton' ) ); ?>">Click More Button</a> (with customizable text)</li>
					<li><strong>...and more!</strong></li>
				</ul>
			</div>
			<p><strong>Bonus:</strong> Envira Lite users get a discount code for 10% off regular price.</p>
			...
			<div class="cta-buttons">
				<a href="<?php echo esc_url( Envira_Gallery_Common_Admin::get_instance()->get_upgrade_link( 'https://enviragallery.com/demo/gallery-pagination-demo/', 'adminpagepagination', 'viewpaginationaddondemo' ) ); ?>" target="_blank" class="button button-secondary">View Pagination Addon Demo</a>
