...
class Envira_Gallery_Common_Admin {
	...
	public function db_upgrade() {
		...
		if ( ! $cpt_galleries ) {
			...
			$excluded_posttypes = array( 'envira', 'envira_album', 'attachment' );
	...
	public function admin_scripts() {
		...
		wp_register_script( $this->base->plugin_slug . '-admin-script', plugins_url( 'assets/js/min/admin-min.js', $this->base->file ), array( 'jquery', 'clipboard' ), $this->base->version, false );
