...
<div class="wrap">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			<h1 class="text-center"><em><a href="https://awplife.com/wordpress-plugins/flickr-gallery-premium/" target="_new">Flickr Gallery Premium Plugin</a></em></h1>
			...
			<div class="thumbnail col-md-5"><br>
				...
				<img class="" src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'img/flickr-responsive-image.png' ); ?>"/>
				<h2 class="text-center"><a class="btn btn-primary btn-lg" href="https://awplife.com/account/signup/flickr-gallery-premium/" target="_new">Purchase Now</a></h2><br>
			</div>
			<div class="thumbnail col-md-6">
				<img class="" src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'img/pricing-table.png' ); ?>"/>
			</div>
				<style>
					.awp_bale_offer {
						background-image: url("<?php echo esc_url( plugin_dir_url( __FILE__ ) . '/img/awp-bale.jpg' ); ?>");
