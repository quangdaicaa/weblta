...
wp_enqueue_script('awl-bootstrap-js', IG_PLUGIN_URL .'js/bootstrap.js', array('jquery'), '' , true);
wp_enqueue_style('thickbox');
wp_enqueue_style('fp-bootstrap-css', IG_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('fp-smartech-css', IG_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('fp-feature-plugins', IG_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('fp-media-uploads',IG_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('fp-bootstrap-min-js',IG_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');
