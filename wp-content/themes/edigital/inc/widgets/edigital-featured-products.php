                                        ...
                                        <div class="product-caption">
                                            ...
                                            <div class="product-details">
                                                <div class="product-btns">
                                                    ...
                                                    <a href="<?php echo esc_url( home_url() ). '?edd_action=add_to_cart&download_id='.get_the_ID(); ?>" class="mt-edd-cart-btn" title="<?php echo esc_attr( 'Add to Cart', 'edigital' ); ?>"><i class="fa fa-shopping-bag"></i></a>
                                                </div><!-- .product-btns -->
                                            </div><!-- .product-details -->
                                        </div><!--. product-caption -->
