...
if ( ! function_exists( 'edigital_dynamic_styles' ) ) :
    ...
    function edigital_dynamic_styles() {
        ...
        $output_css .="a,a:hover,a:focus,a:active,.entry-footer a:hover,.comment-author .fn .url:hover,#cancel-comment-reply-link,#cancel-comment-reply-link:before,.logged-in-as a,.widget a:hover,.widget a:hover::before,.widget li:hover::before,#site-navigation ul li.current-menu-item > a,#site-navigation ul li:hover > a,#site-navigation ul.sub-menu li:hover > a,#site-navigation ul.children li:hover > a,.slide-title span,.edigital_service_section .post-title a:hover,.featured-items-wrapper .prd-title a:hover,.latest-products-wrapper .product-title a:hover,.blog-content-wrapper .news-more,.entry-title a:hover,.entry-meta span a:hover,.post-readmore a:hover,.edd_downloads_list .edd_download_title a:hover,.social-link a:hover,.site-info a:hover,#colophon .site-info a,.blog-content-wrapper .news-title a:hover,.menu-toggle a:hover,.header-search-wrapper .search-main a:hover, .header-search-wrapper .search-form-main .close a:hover{
                        color:". esc_attr( $edigital_skin_color ) ."}\n";

        $output_css .=".navigation .nav-links a,.bttn,button,input[type='button'],input[type='reset'],input[type='submit'],.widget_search .search-submit,.slider-btn a:hover,.featured-items-wrapper .mt-more-btn:hover, .featured-items-wrapper .mt-edd-cart-btn:hover, .latest-products-wrapper .mt-more-btn:hover, .latest-products-wrapper .mt-edd-cart-btn:hover,.widget.widget_tag_cloud a:hover{
