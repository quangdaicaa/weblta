...
<div id="page" class="site">
    ...
    <?php
        /**
         * hook - edigital_before_header
         *
         * @since 1.1.8
         */
        do_action( 'edigital_before_header' );
    ?>
            ...
            <div class="nav-cart-wrapper">
    			...
    			<div class="header-search-wrapper">
	                ...
	                <div class="search-form-main clearfix">
		                <?php get_search_form(); ?>
                        <div class="close"><a href="javascript:void(0)"><i class="fa fa-close"></i></a></div>
		            </div>
    ...
    <?php
        /**
         * hook - edigital_before_content
         *
         * @since 1.1.8
         */
        do_action( 'edigital_before_content' );
    ?>
