...
function sirat_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('sirat_logo_padding',array(
		'label'	=> __('Logo Padding','sirat'),
	...
	$wp_customize->add_setting('sirat_logo_margin',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_logo_margin',array(
		'label'	=> __('Logo Margin','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'sirat' ),
    ),
    ...
    $wp_customize->add_setting('sirat_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'sirat' ),
        ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'sirat_logo_title_hide_show'
	));
	...
	$wp_customize->add_setting('sirat_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'sirat' ),
        ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'sirat_tagline_hide_show'
	));
}
...
function sirat_customize_preview_js() {
	wp_enqueue_script( 'sirat-customizer', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function sirat_customize_controls_js() {
	wp_enqueue_script( 'sirat-customizer-controls', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
