<?php
	...
	if($sirat_theme_lay == 'fixed'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background-attachment: fixed !important; background-position: center !important;';
		$sirat_custom_css .='}';
	}elseif ($sirat_theme_lay == 'scroll'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background-attachment: scroll !important; background-position: center !important;';
		$sirat_custom_css .='}';
	}
