...
if ( ! class_exists( 'Freelancer_Digital_Agency_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Freelancer_Digital_Agency_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Freelancer_Digital_Agency_WPTT_WebFont_Loader( $url );
