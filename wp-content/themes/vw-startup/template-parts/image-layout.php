        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $vw_startup_excerpt = get_the_excerpt(); echo esc_html( vw_startup_string_limit_words( $vw_startup_excerpt, esc_attr(get_theme_mod('vw_startup_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
